...
wget https://ftp.ncbi.nlm.nih.gov/genomes/all/GCF/000/002/985/GCF_000002985.6_WBcel235/GCF_000002985.6_WBcel235_feature_table.txt.gz
wget https://ftp.ncbi.nlm.nih.gov/genomes/all/GCF/000/002/985/GCF_000002985.6_WBcel235/md5checksums.txt

# Checksums
grep "WBcel235_genomic.fna\|WBcel235_genomic.gtf\|WBcel235_rna.fna\|WBcel235_feature_table"  md5checksums.txt > selected_checksums.txt
md5sum -c selected_checksums.txt || {
    ...
    rm -f GCF_000002985.6_WBcel235_feature_table.txt.gz
